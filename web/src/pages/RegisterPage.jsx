    ...
    <div className="container flex-1 flex flex-col items-center justify-center min-h-[80vh] px-4">
      <div className="glass-panel animate-fade-in w-full max-w-md p-8 sm:p-10 shadow-2xl relative overflow-hidden">
        ...
        <div className="text-center mb-8">
          <div className="w-14 h-14 mx-auto mb-4 bg-fuchsia-50 dark:bg-fuchsia-500/10 border border-fuchsia-100 dark:border-fuchsia-500/20 rounded-2xl flex items-center justify-center shadow-inner">
            <UserPlus size={28} className="text-fuchsia-600 dark:text-fuchsia-400" />
          </div>
          <h2 className="text-2xl font-bold mb-2 text-slate-900 dark:text-white">Create an account</h2>
          <p className="text-slate-500 dark:text-slate-400">Start asking questions to your documents.</p>
        </div>
        ...
        <form onSubmit={handleSubmit} className="space-y-4">
          ...
          <div className="space-y-1.5 flex flex-col mb-6">
            ...
            <input type="password" required className="auth-input w-full transition-shadow duration-200" value={passwordConfirm} onChange={(e) => setPasswordConfirm(e.target.value)} placeholder="••••••••" />
          </div>
        ...
        <div className="text-center mt-6 text-sm text-slate-500 dark:text-slate-400">
          Already have an account? <Link to="/login" className="font-semibold text-fuchsia-600 dark:text-fuchsia-400 hover:text-fuchsia-700 dark:hover:text-fuchsia-300 transition-colors">Log in</Link>
        </div>
      </div>
    </div>
  );
